    ...
    <div className="container mx-auto px-4 py-12 md:px-8 animate-in fade-in duration-700">
      <div className="mx-auto max-w-4xl space-y-12">
        <div className="text-center space-y-4 animate-in slide-in-from-top-4 duration-1000">
          <div className="inline-flex items-center justify-center rounded-full bg-primary/10 p-3 text-primary animate-pulse">
        ...
        <div className="grid gap-12 lg:grid-cols-5">
          <div className="lg:col-span-2 space-y-8 animate-in slide-in-from-left-4 duration-700 delay-300">
            <Card className="border-none bg-card shadow-sm transition-all hover:shadow-md">
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  <Bird className="h-5 w-5 text-primary animate-bounce" />
                  Ask Wubanchi
                </CardTitle>
              ...
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-4">
                  <Textarea
                    ...
                    className="min-h-[150px] resize-none rounded-xl transition-all focus:ring-2 focus:ring-primary/20"
                  />
                  <Button 
                    type="submit" 
                    className="w-full rounded-full gap-2 font-bold transition-all active:scale-95 shadow-lg"
              ...
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  <button
                    key={q}
                    onClick={() => setInput(q)}
                    className="rounded-full border bg-background px-4 py-2 text-xs font-medium transition-all hover:bg-primary/10 hover:border-primary active:scale-90"
                  >
                    {q}
                  </button>
                ))}
          ...
          <div className="lg:col-span-3">
            {response ? (
              <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
                <Card className="overflow-hidden border-none bg-primary shadow-xl transition-all hover:shadow-primary/20">
                  <CardContent className="p-0">
                    <div className="bg-white/10 p-4 flex items-center gap-3 border-b border-white/10">
                      <div className="rounded-full bg-white/20 p-1.5 animate-pulse">
                        <Bird className="h-5 w-5 text-white" />
                      </div>
                      <span className="font-bold text-white">Wubanchi's Advice</span>
                    </div>
                    <div className="p-8 space-y-6">
                      <Quote className="h-10 w-10 text-white/20 animate-pulse" />
                      ...
                      <div className="pt-6 border-t border-white/10 flex justify-between items-center">
                        ...
                        <Button variant="ghost" size="sm" onClick={() => setResponse(null)} className="text-white hover:bg-white/10 transition-all active:scale-90">
                          Ask another
                        </Button>
                      </div>
                    </div>
              ...
              <Card className="border-destructive/20 bg-destructive/5 text-destructive text-center p-12 animate-in shake-in-1 duration-500">
                <AlertCircle className="mx-auto h-12 w-12 mb-4" />
                <h3 className="text-xl font-bold mb-2">Oops!</h3>
                <p>{error}</p>
                <Button variant="outline" className="mt-6 rounded-full transition-all active:scale-95" onClick={() => setError(null)}>
                  Try again
                </Button>
              </Card>
            ) : (
              <div className="flex flex-col items-center justify-center h-full min-h-[400px] border-2 border-dashed border-muted rounded-3xl text-center p-8 space-y-4 animate-in fade-in duration-1000 delay-500">
